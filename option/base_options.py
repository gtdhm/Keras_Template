...
class BaseOptions(object):
    ...
    def get_parser():
        ...
        parser = argparse.ArgumentParser(description='Customer Model Template based on Keras.',
        ...
        parser.add_argument('--seed', type=int, default=3,
                            help="set a manual seed for random, np.random")
        ...
        parser.add_argument('--train_bn', type=bool, default=True,
                            help="whether train Batch Normalization Layer")
