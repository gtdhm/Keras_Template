...
class TrainOptions(BaseOptions):
    ...
    def __init__(self):
        ...
        self.BEST_METRIC = 0.0 if 'LOSS' not in self.opts.save_metric else 100.0
        # Redefined the path
    ...
    def add_parser(self):
        ...
        self.parser.add_argument('--epoch', type=int, default=15,
        ...
        self.parser.add_argument('--load_checkpoint', type=str, default='scratch',
                                 help=">>> training from :[scratch]; or load [index | best | checkpoint_name.h5]")
        ...
        self.parser.add_argument('--save_metric', type=str, default='ACC',
                                 help=">>> choose which metric to save >>> [LOSS | ACC]")
